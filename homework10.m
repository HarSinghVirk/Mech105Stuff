%% Homework-10
% Harvinder Singh Virk, Mech-105, Date:22-FEB-2018,Last Edited: 10:00 PM.
% Students are asked to find the value of x.
% x is the mole fraction of water(H20).
clc
clear
close all
...
fzero(f,x0) % This function tries to find point x where y=f(x) is zero. That's the root of the function.
